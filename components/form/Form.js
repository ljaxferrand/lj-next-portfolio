      ...
      >
        <div className="form-group flex flex-col pb-4">
          ...
          <input
            ...
            type="text"
            className="peer border-b-2 rounded-sm border-primaryAccent p-1 bg-offWhite hover:bg-tertiaryAccent dark:  text-offBlack focus:bg-tertiaryAccent dark:focus:text-offBlack"
          />
          {hasError ? (
